  ...
  return (
    <footer 
      ...
      style={{ 
        ...
        borderColor: `rgba(${currentThemeColors.primaryRGB}, 0.1)`
      }}
    >
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          ...
          <div className="col-span-1">
            <h3 
              className="font-bold mb-4 text-sm tracking-wider"
              style={{ 
                color: currentThemeColors.primary,
                fontFamily: "'Share Tech Mono', monospace",
            ...
            <ul className="space-y-2">
              <li>
                <Link 
                  href="/" 
                  className="text-gray-300 text-sm transition-colors duration-200 flex items-center"
                  onMouseOver={(e) => e.currentTarget.style.color = currentThemeColors.primary}
                  onMouseOut={(e) => e.currentTarget.style.color = 'rgb(209, 213, 219)'}
                >
          ...
          <div className="col-span-1">
            ...
            <div className="flex items-center space-x-3">
              <a 
                ...
                className="text-gray-400 p-2 rounded-full transition-all duration-200"
                onMouseOver={(e) => {
                  e.currentTarget.style.color = currentThemeColors.primary;
                  e.currentTarget.style.backgroundColor = `rgba(${currentThemeColors.primaryRGB}, 0.1)`;
                }}
                onMouseOut={(e) => {
            ...
            <div className="mt-6">
              ...
              <form className="flex" onSubmit={(e) => e.preventDefault()}>
                ...
                <button 
                  type="submit" 
                  className="px-3 py-2 text-sm font-semibold rounded-r-md transition-all duration-200"
                  style={{ 
                    background: `rgba(${currentThemeColors.primaryRGB}, 0.2)`,
                    borderTop: `1px solid rgba(${currentThemeColors.primaryRGB}, 0.3)`,
                    borderRight: `1px solid rgba(${currentThemeColors.primaryRGB}, 0.3)`,
                    borderBottom: `1px solid rgba(${currentThemeColors.primaryRGB}, 0.3)`,
                    color: currentThemeColors.primary,
                    textShadow: `0 0 5px rgba(${currentThemeColors.primaryRGB}, 0.5)`
                  }}
                  onMouseOver={(e) => {
                    e.currentTarget.style.backgroundColor = `rgba(${currentThemeColors.primaryRGB}, 0.3)`;
                  }}
                  onMouseOut={(e) => {
                    e.currentTarget.style.backgroundColor = `rgba(${currentThemeColors.primaryRGB}, 0.2)`;
                  }}
                >
                  SUBMIT
                </button>
        ...
        <div 
          className="pt-6 mt-6 flex flex-col md:flex-row justify-between items-center"
          style={{
            borderTop: `1px solid rgba(${currentThemeColors.primaryRGB}, 0.1)`
          }}
        >
          ...
          <div className="mt-4 md:mt-0">
            <div className="flex items-center space-x-4">
              <Link 
                href="/privacy" 
                className="text-gray-400 text-xs transition-colors duration-200"
                onMouseOver={(e) => e.currentTarget.style.color = currentThemeColors.primary}
        ...
        <div className="w-full h-0.5 mt-10 relative overflow-hidden">
          <div 
            ...
            style={{ 
              ...
              boxShadow: `0 0 8px rgba(${currentThemeColors.primaryRGB}, 0.5)`
            }}
          >
          </div>
        </div>
