    ...
    <div className="container mx-auto px-4 py-12 max-w-4xl mt-16">
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-xl text-gray-300 mb-6">
          The story behind the i did this school project to test the speed of a network. it runs on local storage but in netlify it checks server speed to the webhosted area i didnt knew it until deployed it.if you want to check your network make sure to run it locally
        </p>
